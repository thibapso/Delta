...
import styles from "./Footer.module.css"; // Certifique-se de que o caminho está correto
        ...
        <div className={styles.row}>
          <div className={`${styles.footerCol} ${styles.footerLogoCol}`}>
            <div className={styles.footerLogo}>
              ...
              <p className={styles.footerLogoParagrafo}>
                Problemas com conversões? O Delta resolve para você. É fácil de encontrar!
              </p>
            </div>
          </div>
          <div className={styles.footerCol}>
            ...
            <ul>
              ...
              <li><a href="#formas">Formas</a></li>
            </ul>
          </div>
          <div className={styles.footerCol}>
            <h4>Repositório</h4>
            <ul>
              <li><a href="https://github.com/thibapso/delta" target="_blank">GitHub - Delta</a></li>
            </ul>
          </div>
          <div className={styles.footerCol}>
            <h4>Me Siga</h4>
